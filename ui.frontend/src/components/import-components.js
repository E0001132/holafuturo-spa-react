...
import BenefitsList from './BenefitsList/BenefittsList';
...
MapTo('holafuturospa/components/button')(Button);
MapTo('holafuturospa/components/input')(Input);
MapTo('holafuturospa/components/benefit-list')(BenefitsList);
